...
export default function Socials () {
  return (
    <div className='flex flex-wrap justify-center gap-2'>
      <Link
        to={{ pathname: 'https://www.instagram.com/cc.zeta/' }}
        target='_blank'
      >
        <button
          className='bg-gradient-to-b from-indigo-500 via-pink-500 to-yellow-200 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded'
        >
          <svg
      ...
      <Link
        to={{ pathname: 'https://github.com/EtZeta/ViteZeusTemplate' }}
        target='_blank'
      >
